...
#只需改动
id=intersects(rownames(Trainset_Clin),rownames(Trainset_Met),rownames(Trainset_RNA),rownames(Trainset_Path))
Train=cbind(Trainset_Path[match(id,rownames(Trainset_Path)),],Trainset_RNA[match(id,rownames(Trainset_RNA)),],Trainset_Met[match(id,rownames(Trainset_Met)),],Trainset_Clin[match(id,rownames(Trainset_Clin)),])
Test=cbind(test_path,test_rna,test_Met,test_Clin)
