...
#只需改动
id=intersects(rownames(Trainset_Clin),rownames(Trainset_Met))
Train=cbind(Trainset_Met[match(id,rownames(Trainset_Met)),],Trainset_Clin[match(id,rownames(Trainset_Clin)),])
Test=cbind(test_Met,test_Clin)
