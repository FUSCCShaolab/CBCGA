...
#只需改动
id=intersects(rownames(Trainset_Clin),rownames(Trainset_Met),rownames(Trainset_rad))
Train=cbind(Trainset_rad[match(id,rownames(Trainset_rad)),],Trainset_Met[match(id,rownames(Trainset_Met)),],Trainset_Clin[match(id,rownames(Trainset_Clin)),])
Test=cbind(test_rad,test_Met,test_Clin)
