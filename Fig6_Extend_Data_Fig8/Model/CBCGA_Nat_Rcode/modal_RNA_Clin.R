...
#只需改动
id=intersects(rownames(Trainset_Clin),rownames(Trainset_RNA))
Train=cbind(Trainset_RNA[match(id,rownames(Trainset_RNA)),],Trainset_Clin[match(id,rownames(Trainset_Clin)),])
Test=cbind(test_rna,test_Clin)
