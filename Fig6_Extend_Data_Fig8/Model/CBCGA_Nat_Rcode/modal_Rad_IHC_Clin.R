...
id=intersects(rownames(Trainset_IHC),rownames(Trainset_Clin),rownames(Trainset_rad))
Train=cbind(Trainset_rad[match(id,rownames(Trainset_rad)),],Trainset_Clin[match(id,rownames(Trainset_Clin)),],Trainset_IHC[match(id,rownames(Trainset_IHC)),])
Test=cbind(test_rad,test_Clin,test_IHC)
