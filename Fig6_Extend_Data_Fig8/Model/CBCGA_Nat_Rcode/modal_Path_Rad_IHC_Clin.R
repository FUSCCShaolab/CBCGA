...
id=intersects(rownames(Trainset_IHC),rownames(Trainset_Clin),rownames(Trainset_rad),rownames(Trainset_Path))
Train=cbind(Trainset_Path[match(id,rownames(Trainset_Path)),],Trainset_rad[match(id,rownames(Trainset_rad)),],Trainset_Clin[match(id,rownames(Trainset_Clin)),],Trainset_IHC[match(id,rownames(Trainset_IHC)),])
Test=cbind(test_path,test_rad,test_Clin,test_IHC)
